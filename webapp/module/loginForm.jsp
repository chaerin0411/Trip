...
<%
	...
	String joinEnd		= (String)session.getAttribute("joinEnd");
 	...
 	if (loginSave == null) {
 		...
 		idStr = member_id; pwStr = member_pwd; checkStr = "checked";
 	}
 	if (loginPcs == "false") { %>
            ...
            <fieldset id="login_form">
                ...
                <div id="id_area">
                    <div class="input_row">
                        ...
                        <div class="input_box">
                            <input id="id" type="text" name="member_id" placeholder="아이디" value="<%= idStr %>">
                        </div>
                    </div>
                </div>
                ...
                <div id="pw_area">
                    <div class="input_row">
                        ...
                        <div class="input_box">
                            <input id="pw" type="password" name="member_pwd" placeholder="비밀번호" value="<%= pwStr %>">
                        </div>
                    </div>
                </div>
